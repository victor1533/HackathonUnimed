...
import br.com.lapps.hackathonunimed.controller.FinancasController;
...
public class FinancasActivity extends AppCompatActivity {
    ...
    private static int TODOS = 0;
    private static int ABERTO = 1;
    private static int FECHADO = 2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_financas);
        controller = new FinancasController(this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_financas, menu);
        return true;
    }
